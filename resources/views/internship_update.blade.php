          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                  <form action="{{route('internships.update',$user->id)}}" method="post">
                  @csrf 
                  @method('PATCH')
                ...
                @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Enter Position" name="position" autocomplete="off" value="{{$user->position}}" required >
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Internship Start Date</label>
                      <input type="date" class="form-control" id="exampleInputPassword1" name="st_date"  value="{{$user->st_date}}"required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Internship End Date</label>
                      <input type="date" class="form-control" id="exampleInputPassword1" name="end_date" value="{{$user->end_date}}"required>
                    </div>
                    <!-- <div class="form-group">
