...
@section('content')
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Experience Letter Form</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item">Forms</li>
              <li class="breadcrumb-item active" aria-current="page">Experience Letter Form</li>
            </ol>
          </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Experience Letter Form</h6>
                </div>
                <div class="card-body">
                  <form method="post" action="{{route('experiences.update',$user->id)}}">
                    @csrf
                    @method('PATCH')
            ...
            <option>Select Employee</option>
                ...
                @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"placeholder="Enter Job Role" name="Job_role" value="{{$user->Job_role}}">
