...
<head>
  ...
  <link href="{{asset('img/vertex.png')}}" rel="icon">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/index">
        ...
        <link href="{{asset('img/logo/vertex.png')}}" rel="icon">
        </div>
        <div class="sidebar-brand-text mx-3">Vertex Certifications</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/emps">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Employee Details</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/releivings">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="/industrials">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Industrial Internship</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/sponsorships">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Sponsership Letters</span>
        </a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/empsearch">
          <i class="fas fa-fw fa-chart-area"></i>
