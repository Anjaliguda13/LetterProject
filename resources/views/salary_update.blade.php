          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <div class="card mb-4">
                ...
                <div class="card-body">
                <form action="{{route('salaries.update',$user->id)}}" method="post" >
                  @csrf
                  @method('PATCH');
                ...
                @endforeach
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Enter Designation" name="design" autocomplete="off" value="{{$user->design}}"required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Enter Basic Salary</label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="basic_sal" placeholder="Enter Basic Salary" autocomplete="off" value="{{$user->basic_sal}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Enter TDS + Professional Tax </label>
                      <input type="text" class="form-control" id="exampleInputPassword1" name="tax" placeholder="Enter tax" autocomplete="off" value="{{$user->tax}}" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleFormControlSelect1">Example select</label>
                      <select class="form-control" id="exampleFormControlSelect1" name="salmode" value="{{$user->salmode}}">
